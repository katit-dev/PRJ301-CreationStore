    ...
    <body class="bg-light-green d-block justify-content-center align-items-center" style="height: 100vh;">
        ...
        <div class="container mt-5">
            <div class="card shadow-sm rounded-4 p-4 mx-auto" style="max-width: 500px;">
                <h3 class="text-center text-success mb-3">Change Password</h3>
                ...
                <form action="MainController" method="POST">
                    ...
                    <div class="mb-3 position-relative">                       
                        ...
                        <input type="password" class="form-control pe-5" name="newPassword" id="newPassword"
                               required value="${not empty requestScope.newPassword ? requestScope.newPassword : ""}">
                        <i class="fa fa-eye position-absolute top-70 end-0 translate-middle-y me-3 toggle-password"
                           toggle="#newPassword" style="cursor: pointer;"></i>
                    </div>
                    <div class="mb-3 position-relative">
                        <label for="password" class="form-label">Confirm Password</label>
                        <input type="password" class="form-control pe-5" id="passwordConfirm" name="passwordConfirm" 
                               required value="${not empty requestScope.passwordConfirm ? requestScope.passwordConfirm : ""}">
                        <i class="fa fa-eye position-absolute top-70 end-0 translate-middle-y me-3 toggle-password"
                           toggle="#passwordConfirm" style="cursor: pointer;"></i>
                    </div>
